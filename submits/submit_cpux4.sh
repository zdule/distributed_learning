...
options="envarg://PMI_SIZE envarg://PMI_RANK 1 4 $ip_addr ib0 imagenet /rds/user/dz308/hpc-work 0 --job_id $SLURM_JOB_ID --experiment experiment3 --limit_batches 80 --random_input 1 --batch_size 4"
